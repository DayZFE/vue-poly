...
export declare const bondGet: {
  ...
  <
    ...
    TKey1 extends keyof TObject_3,
    TKey2 extends keyof TObject_3[TKey1]
  >(
    object: TObject_3,
    path: [TKey1, TKey2]
  ...
  <
    ...
    TKey1_1 extends keyof TObject_4,
    TKey2_1 extends keyof TObject_4[TKey1_1]
  >(
  ...
  <
    ...
    TKey1_2 extends keyof TObject_5,
    TKey2_2 extends keyof TObject_5[TKey1_2],
    TDefault_1
  >(
  ...
  >(
    ...
    | TDefault_3
    | Exclude<TObject_11[TKey1_8][TKey2_8][TKey3_5][TKey4_2], undefined>;
  <T>(object: import("lodash").NumericDictionary<T>, path: number): T;
  <T_1>(
    object: import("lodash").NumericDictionary<T_1> | null | undefined,
    path: number
  ): T_1 | undefined;
  <T_2, TDefault_4>(
  ...
  <TDefault_5>(
    ...
    path: import("lodash").Many<string | number | symbol>,
...
export declare function definePoly<
  T extends {
    id: PolyID;
    through?: boolean;
    [key: string]: any;
...
>(poly: T): T;
export declare function bond<T>(
  id: PolyID,
  queryPath: QueryPath,
  defaultValue: T
): T;
export declare function watchPoly(
  poly: {
    id: PolyID;
    through?: boolean;
    [key: string]: any;
